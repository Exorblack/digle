  ...
  return (
    <>
      <section
        ref={containerRef}
        id={id}
        className="relative overflow-hidden bg-[#9b9b9b] "
      >
        <div
          ref={cardsRef}
        ...
        >
          {/* Slide 1 */}
          <div className=" relative bg-[#282728]/95 h-[70dvh] w-[85vw] md:w-[70vw] lg:w-[50vw] rounded-[100px] overflow-hidden">
            <div className="absolute inset-0  bg-opacity-50 flex flex-col justify-center items-center text-center text-white p-4 md:px-6">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold  mb-2 md:mb-4 text-[#ffff]">
                WHO WE ARE
              </h2>
              <p className="text-base md:text-lg mb-3 md:mb-5 text-[#FFB703]">
                &quot;we bring your digital dreams to life&quot;
              </p>
              <p className="description text-xl sm:text-2xl w-[95%] md:w-[90%] text-[#fff] leading-relaxed">
                We&apos;re not just developers - we&apos;re your digital
                transformation partners. we combine proven expertise with
                cutting-edge technology to guide you toward digital excellence.
              </p>
            </div>
          </div>
          {/* Slide 2 */}

          <div className="relative h-[70vh] w-[85vw] md:w-[70vw] lg:w-[50vw] bg-[#4ea8de]/95 rounded-[100px] overflow-hidden">
            <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-center items-center text-center p-4 md:px-6">
              ...
              <p className="text-base md:text-lg mb-3 md:mb-5 text-[#FFB703]/90">
